package example.androidgrid.notes.user_sign;
...
import example.androidgrid.notes.MainActivity;
import example.androidgrid.notes.R;

public class LoginActivity extends AppCompatActivity {

    TextInputLayout inputEmail, inputPass;
    TextInputEditText iemail,ipass;
